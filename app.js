...
function downloadPdfReport() {
  ...
  doc.setFontSize(18);
  doc.text("Anna University CGPA Calculator", 20, 20);

  doc.setFont("helvetica", "normal");
  doc.setFontSize(11);
  doc.text("Generated by CGPA Buddy", 20, 28);
  ...
  doc.text("Point", 185, y, { align: "right" });
  ...
  lastCalculation.subjects.forEach((subject) => {
    ...
    doc.text(subject.subjectName, 20, y, { maxWidth: 95 });
    doc.text(subject.grade, 125, y);
    doc.text(String(subject.credits), 155, y);
    doc.text(String(subject.gradePoint), 185, y, { align: "right" });
    y += 10;
  });
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(13);
  doc.text(`Total Credits: ${lastCalculation.totalCredits}`, 20, y);
  y += 8;
  doc.text(`CGPA: ${lastCalculation.cgpa.toFixed(2)}`, 20, y);
